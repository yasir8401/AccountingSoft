...
namespace ErpOnClick.DAL.Dependencies
{
    public static class ServicesDependency
    {
        public static void AddServicesDependency(this IServiceCollection services)
        {
            ...
            services.AddScoped<IJustificationLetterService, JustificationLetterService>();
            services.AddScoped<IEmpEvaluationService, EmpEvaluationService>();


            //For  Project Management System(PMS)
            services.AddScoped<IPMSCompanyService, PMSCompanyService>();
            services.AddScoped<IPMSMessagesService, PMSMessagesService>();
            services.AddScoped<IPMSProjectsService, PMSProjectsService>();
            services.AddScoped<IPMSProjectTasksService, PMSProjectTasksService>();
            services.AddScoped<IPMSProjectTeamService, PMSProjectTeamService>();
            services.AddScoped<IPMSTaskAttachmentsService, PMSTaskAttachmentsService>();
            services.AddScoped<IPMSUserService, PMSUserService>();
            ...
            services.AddScoped<IApplicationParameterService , ApplicationParameterService>();
