...
namespace ErpOnClick.DAL.Models
{
    public partial class ERPonClickContext : DbContext
    {
        ...
        public virtual DbSet<EmpEvaluation> EmpEvaluation { get; set; }
        ...
        public virtual DbSet<JustificationLetter> JustificationLetter { get; set; }
        ...
        public virtual DbSet<PmsCompany> PmsCompany { get; set; }
        public virtual DbSet<PmsMessages> PmsMessages { get; set; }
        public virtual DbSet<PmsProjectTasks> PmsProjectTasks { get; set; }
        public virtual DbSet<PmsProjectTeam> PmsProjectTeam { get; set; }
        public virtual DbSet<PmsProjects> PmsProjects { get; set; }
        public virtual DbSet<PmsTaskAttachments> PmsTaskAttachments { get; set; }
        public virtual DbSet<PmsUser> PmsUser { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                ...
                optionsBuilder.UseSqlServer("Server=.; Database=DB_A29478_nsDBNew; User Id=sa;Password=P@kistan; Persist Security Info=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Accounts>(entity =>
            {
                ...
                entity.Property(e => e.AccountNatureId)
                    .HasColumnName("ACCOUNT_NATURE_ID")
                    .HasMaxLength(6)
                    .IsUnicode(false);
...
5- Contract Signed");
            ...
            modelBuilder.Entity<EmpEvaluation>(entity =>
            {
                entity.HasKey(e => e.RecId);

                entity.ToTable("EMP_EVALUATION", "HR");
                ...
                entity.Property(e => e.EvaluationQuarter)
                    .HasColumnName("EVALUATION_QUARTER")
                    .HasMaxLength(6)
                    .IsUnicode(false);
                ...
                entity.HasOne(d => d.ApprovalStatusNavigation)
                    .WithMany(p => p.EmpEvaluation)
                    .HasForeignKey(d => d.ApprovalStatus)
                    .HasConstraintName("FK_EMP_EVALUATION_LOOKUPS");

                entity.HasOne(d => d.Branch)
                    .WithMany(p => p.EmpEvaluation)
                    .HasForeignKey(d => d.BranchId)
                    .HasConstraintName("FK_EMP_EVALUATION_BRANCH");

                entity.HasOne(d => d.Company)
                    .WithMany(p => p.EmpEvaluation)
                    .HasForeignKey(d => d.CompanyId)
                    .HasConstraintName("FK_EMP_EVALUATION_COMPANY");

                entity.HasOne(d => d.Emp)
                    .WithMany(p => p.EmpEvaluation)
                    .HasForeignKey(d => d.EmpId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_EMP_EVALUATION_EMP");
            });
...
");
            ...
            modelBuilder.Entity<JustificationLetter>(entity =>
            {
                entity.HasKey(e => e.RecId);

                entity.ToTable("JUSTIFICATION_LETTER", "HR");
                ...
                entity.HasOne(d => d.ApprovalStatusNavigation)
                    .WithMany(p => p.JustificationLetter)
                    .HasForeignKey(d => d.ApprovalStatus)
                    .HasConstraintName("FK_JUSTIFICATION_LETTER_LOOKUPS");

                entity.HasOne(d => d.Emp)
                    .WithMany(p => p.JustificationLetter)
                    .HasForeignKey(d => d.EmpId)
                    .HasConstraintName("FK_JUSTIFICATION_LETTER_EMP");
            });
            ...
            modelBuilder.Entity<PmsCompany>(entity =>
            {
                entity.HasKey(e => e.CompanyId)
                    .HasName("PK_Company");

                entity.ToTable("PMS_Company", "PMS");

                entity.Property(e => e.CompanyId).HasColumnName("Company_Id");

                entity.Property(e => e.CompanyAddress).HasColumnName("Company_Address");

                entity.Property(e => e.CompanyImageUrl).HasColumnName("Company_Image_URL");
            ...
            modelBuilder.Entity<PmsMessages>(entity =>
            {
                entity.HasKey(e => e.MessageId)
                    .HasName("PK_Messages");

                entity.ToTable("PMS_Messages", "PMS");
                ...
                entity.HasOne(d => d.SendByNavigation)
                    .WithMany(p => p.PmsMessagesSendByNavigation)
                    .HasForeignKey(d => d.SendBy)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_Messages_User");

                entity.HasOne(d => d.SendToNavigation)
                    .WithMany(p => p.PmsMessagesSendToNavigation)
                    .HasForeignKey(d => d.SendTo)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_Messages_User1");

                entity.HasOne(d => d.Task)
                    .WithMany(p => p.PmsMessages)
                    .HasForeignKey(d => d.TaskId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_Messages_Project_Tasks");
            });

            modelBuilder.Entity<PmsProjectTasks>(entity =>
            {
                entity.HasKey(e => e.TaskId)
                    .HasName("PK_Project_Tasks");

                entity.ToTable("PMS_Project_Tasks", "PMS");
                ...
                entity.Property(e => e.TaskCompletedPercentage).HasColumnName("Task_Completed_Percentage");

                entity.Property(e => e.TaskCreatedBy).HasColumnName("Task_Created_By");
                ...
                entity.Property(e => e.TaskPublishedUrl).HasColumnName("Task_Published_URL");
                ...
                entity.HasOne(d => d.AssignedTo)
                    .WithMany(p => p.PmsProjectTasksAssignedTo)
                    .HasForeignKey(d => d.AssignedToId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_Project_Tasks_User");

                entity.HasOne(d => d.Project)
                    .WithMany(p => p.PmsProjectTasks)
                    .HasForeignKey(d => d.ProjectId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_Project_Tasks_Projects");

                entity.HasOne(d => d.TaskCreatedByNavigation)
                    .WithMany(p => p.PmsProjectTasksTaskCreatedByNavigation)
                    .HasForeignKey(d => d.TaskCreatedBy)
                    .HasConstraintName("FK_Project_Tasks_User1");
            });

            modelBuilder.Entity<PmsProjectTeam>(entity =>
            {
                entity.HasKey(e => e.TeamId)
                    .HasName("PK_Project_Team");

                entity.ToTable("PMS_Project_Team", "PMS");
                ...
                entity.HasOne(d => d.Project)
                    .WithMany(p => p.PmsProjectTeam)
                    .HasForeignKey(d => d.ProjectId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_Project_Team_Projects");

                entity.HasOne(d => d.ProjectUser)
                    .WithMany(p => p.PmsProjectTeam)
                    .HasForeignKey(d => d.ProjectUserId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_Project_Team_User");
            });

            modelBuilder.Entity<PmsProjects>(entity =>
            {
                entity.HasKey(e => e.ProjectId)
                    .HasName("PK_Projects");

                entity.ToTable("PMS_Projects", "PMS");
                ...
                entity.HasOne(d => d.Company)
                    .WithMany(p => p.PmsProjects)
                    .HasForeignKey(d => d.CompanyId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_Projects_Company");
            });

            modelBuilder.Entity<PmsTaskAttachments>(entity =>
            {
                entity.HasKey(e => e.TaskAttachmentId)
                    .HasName("PK_Task_Attachments");

                entity.ToTable("PMS_Task_Attachments", "PMS");

                entity.Property(e => e.TaskAttachmentId).HasColumnName("Task_Attachment_Id");

                entity.Property(e => e.TaskAttachmentName).HasColumnName("Task_Attachment_Name");

                entity.Property(e => e.TaskAttachmentUrl).HasColumnName("Task_Attachment_URL");

                entity.Property(e => e.TaskId).HasColumnName("Task_Id");

                entity.HasOne(d => d.Task)
                    .WithMany(p => p.PmsTaskAttachments)
                    .HasForeignKey(d => d.TaskId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_Task_Attachments_Project_Tasks");
            });

            modelBuilder.Entity<PmsUser>(entity =>
            {
                entity.HasKey(e => e.UserId)
                    .HasName("PK_User");

                entity.ToTable("PMS_User", "PMS");
                ...
                entity.Property(e => e.UserManagerId).HasColumnName("User_Manager_Id");
                ...
                entity.HasOne(d => d.Company)
                    .WithMany(p => p.PmsUser)
                    .HasForeignKey(d => d.CompanyId)
                    .HasConstraintName("FK_User_Company");

                entity.HasOne(d => d.UserManager)
                    .WithMany(p => p.InverseUserManager)
...
Absent With Excuse");
            ...
            {
                entity.HasKey(e => e.ApplicationParameterId);

                entity.ToTable("APPLICATION_PARAMETERS", "FN");

                entity.Property(e => e.ApplicationParameterId).HasColumnName("APPLICATION_PARAMETER_ID");
                ...
                entity.Property(e => e.FinancialYearEndMonth)
                    .IsRequired()
                ...
                entity.Property(e => e.CompanyNameAr).HasColumnName("COMPANYNAME_AR");

                entity.Property(e => e.CompanyLogoUrl).HasColumnName("COMPANY_LOGO_URL");
                entity.Property(e => e.CompanyPhone1).HasColumnName("COMPANY_PHONE1");
                entity.Property(e => e.CompanyPhone2).HasColumnName("COMPANY_PHONE2");
                entity.Property(e => e.CompanyWebsite).HasColumnName("COMPANY_WEBSITE");
                entity.Property(e => e.CompanyAddressEn).HasColumnName("COMPANY_ADDRESS_EN");
                entity.Property(e => e.CompanyAddressAr).HasColumnName("COMPANY_ADDRESS_AR");
                entity.Property(e => e.ReportFooterSignatureManager1).HasColumnName("REPORT_FOOTER_SIGNATURE_MANAGER1");
                entity.Property(e => e.ReportFooterSignatureManager2).HasColumnName("REPORT_FOOTER_SIGNATURE_MANAGER2");
