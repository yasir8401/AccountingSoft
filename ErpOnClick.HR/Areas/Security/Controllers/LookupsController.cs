...
namespace ErpOnClick.DAL.Areas.Admin.Controllers
{
    ...
    public class LookupsController : Controller
    {
        ...
        public IActionResult edit(string id)
        {
            ...
            if (id != null)
            {
                expObj.LookupParentList = _LookupsService.Find(x => x.LookupTypeId == _LookupTypesService.GetById(_LookupsService.GetById(id).LookupTypeId).ParentCode).ToList();
            }
            else
            {
                expObj.LookupParentList = null;
            }
        ...
        public ActionResult save(Lookups postedData)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                else
                {
                    ...
                    if (postedData.ParentCode == "Please Select....")
                        postedData.ParentCode = null;
        ...
        [HttpPost]
        public ActionResult ParentLookupsList(string parentLookupId)
        {
            var parentLookupList = _LookupsService.Find(x => x.LookupTypeId == _LookupTypesService.GetById(parentLookupId).ParentCode).ToList();

            return Json(new { result = parentLookupList });
        }
