...
namespace ErpOnClick.ErpMain.Areas.Admin.Controllers
{
    ...
    public class VendorsController : Controller
    {
        ...
        public VendorsController(IUserService UserService,ILogger<VendorsController> logger, ICompanyService CompanyService, IBranchService BranchService, ILookupsService LookupTypesService, IVendorsService VendorsService, IAccountsService AccountsService)
        {
            _logger = logger;
