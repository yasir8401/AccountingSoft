    ...
    public class EmpController : Controller
    {
        ...
        public async Task<ActionResult> save(EmpInheritied postedData)
        {
            ...
            if (postedData != null)
            {
                ...
                {
                    if (!(postedData.EmpCode != null && postedData.EmpCode.Trim() != "" && postedData.EmpCode.Length > 2))
                    {
                    ...
                    {
                        var emp = _EmpService.Find(x => x.EmpCode == postedData.EmpCode).FirstOrDefault();
                        if (emp != null)
                        {
                            result.isError = true;
                            result.msg = "Emp Code " + postedData.EmpCode + " is already exists !";
                        }
                    }
        ...
        public async Task<ActionResult> update(EmpInheritied postedData)
        {
            ...
            if (postedData != null)
            {
                ...
                if (postedData.EmpCode != null)
                {
                    var empCode = _EmpService.Find(x => x.EmpCode == postedData.EmpCode && x.EmpId != postedData.EmpId).FirstOrDefault();
                    if (empCode != null)
                    {
                        result.isError = true;
                        result.msg = "Emp Code " + postedData.EmpCode + " is already exists !";
                ...
                postedData.EmpCode = postedData.EmpCode;
        ...
        [HttpPost]
        public IActionResult Test(ErpOnClick.DAL.Models.Emp emp)
        {
